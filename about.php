            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="Municipio.php">Municipios cercanos</a>
                        </li>                                             
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>Saber mas de las comunidades </h1>
                    <p>
                ...
                <div class="col-md-4">
                    <img src="./public/images/actividades economicas.jpeg" alt="About Hero">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">Saber mas</h2>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            ...
                            | Designed by <a rel="sponsored" href="https://templatemo.com/page/1" target="_blank"></a>
                        </p>
                    </div>
                </div>
            </div>
